...
func (t Task) Reveal(topic string) string {
	...
	if len(fields) == 0 {
		return "По этой теме в карточке нет заранее заданных фактов. Не выдумывай цифры и требования. Если вопрос уместный — попроси кандидата сделать разумное предположение и дальше опираться на него; когда назовёт — оцени, реалистично ли оно или совсем мимо."
	}
